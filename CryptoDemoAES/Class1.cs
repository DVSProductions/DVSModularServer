...
namespace CryptoDemoAES {
	...
	public class Class1 : IServerCrypto {
		...
		/// example salt
		/// </summary>
		private static readonly byte[] salt = new byte[] { 102, 47, 130, 95, 103, 207, 197, 222, 30, 36, 210, 92, 254, 61, 55, 173, 118, 15, 57, 15, 200, 118, 224, 203, 218, 160, 178, 183, 180, 112, };
		/// <summary>
